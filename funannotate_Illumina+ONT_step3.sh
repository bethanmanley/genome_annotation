...
#SBATCH -N 1
#SBATCH -n 16
#SBATCH -o fun.postupdate.step3.out
#SBATCH -e fun.postupdate.step3.err
...
funannotate annotate --gff Rhizophagus_irregularis_DAOM197198.gff3 --fasta Rirr.curated_primary.no_mt.unscrubbed.fa.masked -s "Rhizophagus irregularis" -o funct_annot_postupdate/ \
--sbt Genbanktemplate.sbt --eggnog eggnog_vs_annot.emapper.annotations --antismash Rirr.curated_primary.no_mt.unscrubbed.gbk \
--iprscan Rhizophagus_irregularis_DAOM197198.proteins.fa.xml  \
--isolate DAOM197198 --busco_db fungi --cpus 16
